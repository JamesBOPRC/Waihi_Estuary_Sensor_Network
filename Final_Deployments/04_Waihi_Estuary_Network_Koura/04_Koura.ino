...
const char *sketchName = "04_Koura.ino";
// Logger ID, also becomes the prefix for the name of the data file on SD card
const char *LoggerID = "Koura";
...
Variable *variableList[] = {
    ...
    new ProcessorStats_Battery(&mcuBoard,"a3eaac39-7b49-429e-9a55-2e3702eca2ad"),
    new MaximDS3231_Temp(&ds3231,"2f58d826-24ac-4354-bbff-89c03bd86e2f"),
    new DecagonCTD_Cond(&ctd, "9605222e-74b4-41f5-842d-fcf37314042d"),
    new DecagonCTD_Temp(&ctd, "c18c9b1e-f62c-450f-a111-c49b0882e27a"),
        new DecagonCTD_Depth(&ctd, "6458fa2b-2153-4266-af88-7816c56e025e"),
        new YosemitechY511_Turbidity(&y511, "f37af710-53b0-4b5f-b02f-99640f232570"),
        new YosemitechY511_Temp(&y511, "705af0e9-d27c-488a-bed3-67abf3fa2962")
...
const char *registrationToken = "6c7ccbaf-ab30-49d2-9d32-97d628eb8757";   // Device registration token
const char *samplingFeature = "57e9211a-0068-45af-afd3-d7c5dfee509e";     // Sampling feature UUID
