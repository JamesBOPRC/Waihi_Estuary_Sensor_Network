...
const float Kvalue = 2.038702503;//updated 05/11/2020
//const float Kvalue = 1;//


 //1.0 means no change to raw readings
...
//stripping out the temperature compensation element to raw voltage.  Hopefully this will help us decipher the problem.
  SpC=averageVoltage;
