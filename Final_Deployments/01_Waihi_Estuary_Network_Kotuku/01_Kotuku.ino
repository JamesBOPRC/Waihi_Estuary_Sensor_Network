...
const char *sketchName = "01_Kotuku.ino";
// Logger ID, also becomes the prefix for the name of the data file on SD card
const char *LoggerID = "Kotuku";
...
Variable *variableList[] = {
    ...
    new ProcessorStats_Battery(&mcuBoard,"d195c5ef-3160-4940-a504-c920323b0a4b"),
    new MaximDS3231_Temp(&ds3231,"87acc845-07d8-43d4-8080-763e3adc8c25"),
    new DecagonCTD_Cond(&ctd, "89c0516d-20ad-4584-bac2-6301a5e502ba"),
    new DecagonCTD_Temp(&ctd, "1a1643ab-e65c-4d12-9e8d-969df6e958c6"),
        new DecagonCTD_Depth(&ctd, "55a26a4f-ce53-4f53-a753-31d6fb074370"),
        new YosemitechY511_Turbidity(&y511, "f0ad41dc-b2aa-453e-af19-02f55698d8bd"),
        new YosemitechY511_Temp(&y511, "8d9b8f01-1db7-49ba-8d5b-64e16a59bfca")
...
const char *registrationToken = "a2dba64d-8e0e-4fc9-bb8d-66558a5b4bb0";   // Device registration token
const char *samplingFeature = "ed2c7458-8428-46f7-88cb-6b1ffed33233";     // Sampling feature UUID
