...
const char *sketchName = "05_Patiki.ino";
// Logger ID, also becomes the prefix for the name of the data file on SD card
const char *LoggerID = "Patiki";
...
Variable *variableList[] = {
    ...
    new ProcessorStats_Battery(&mcuBoard,"03c5abcd-dfd6-4c58-b028-5cf6e2c95d57"),
    new MaximDS3231_Temp(&ds3231,"1cd4ab1f-507a-4072-a8dc-e2927658f59e"),
    new DecagonCTD_Cond(&ctd, "777c00d8-4beb-4075-94bb-b24889d0d7b6"),
    new DecagonCTD_Temp(&ctd, "bafbbb51-9d2d-4cd9-aa30-e90911bd0bb5"),
        new DecagonCTD_Depth(&ctd, "93faac2a-9db2-45cc-808e-d26935e0c3b3"),
        new YosemitechY511_Turbidity(&y511, "ced82100-f7bb-4cfb-994c-0981c1bb92ca"),
        new YosemitechY511_Temp(&y511, "833d69ef-c52f-4480-8e80-151322fb8532")
...
const char *registrationToken = "9ce32f4c-faeb-4657-8fdb-31c515b66348";   // Device registration token
const char *samplingFeature = "65c04ec5-acd2-46fa-8c09-3a1ebd05672f";     // Sampling feature UUID
