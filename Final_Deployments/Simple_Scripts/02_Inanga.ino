...
const char *sketchName = "02_Inanga.ino";
// Logger ID, also becomes the prefix for the name of the data file on SD card
const char *LoggerID = "Inanga";
...
Variable *variableList[] = {
    ...
    new ProcessorStats_Battery(&mcuBoard,"807092a6-15a5-4a9e-8e21-0dada1a74b29"),
    new MaximDS3231_Temp(&ds3231,"16de3393-3fa0-4ca2-92cf-c42d0b1fcf1e"),
    new DecagonCTD_Cond(&ctd, "166acbc1-b407-4450-ab42-2f2e1739cbfa"),
    new DecagonCTD_Temp(&ctd, "11645b96-3fca-445b-9fb1-c7dbce16f178"),
        new DecagonCTD_Depth(&ctd, "43956453-adfa-47fe-a137-e577fd059798"),
        new YosemitechY511_Turbidity(&y511, "af350051-14c7-4ff8-b020-50c789f1de50"),
        new YosemitechY511_Temp(&y511, "b836eb60-8142-4cc0-b403-082fd3c58639")
...
const char *registrationToken = "148708d3-8db5-46e6-b0bf-570fd79e0352";   // Device registration token
const char *samplingFeature = "55858cc1-d37a-4819-95b7-9eaba4f44956";     // Sampling feature UUID
