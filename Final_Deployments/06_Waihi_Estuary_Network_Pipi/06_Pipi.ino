...
Variable *variableList[] = {
    ...
    new ProcessorStats_Battery(&mcuBoard,"d156c852-f9a8-4bb3-a749-56d36a93760a"),
    new MaximDS3231_Temp(&ds3231,"c9ec040b-0423-42d1-b9ec-bdab43a9c5c2"),
    new DecagonCTD_Cond(&ctd, "8790301f-3f0a-49e7-82fc-f00f3d497c59"),
    new DecagonCTD_Temp(&ctd, "79fb5f96-c097-4df6-8dfb-5ec534893b4f"),
        new DecagonCTD_Depth(&ctd, "0aca6dda-988c-4c5d-b9c0-e524f11f7c71"),
...
const char *registrationToken = "74646130-fcf5-4cc7-9773-c093bb9536fa";   // Device registration token
const char *samplingFeature = "402e034f-5674-41d6-bad3-9b04e806df49";     // Sampling feature UUID
