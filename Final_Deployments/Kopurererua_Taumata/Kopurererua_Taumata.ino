...
//    pH sensor settings
// ==========================================================================
const int pHSensorPin = 0; //check pH sensor pin.
...
Variable *variableList[] = {
    ...
    new Variable(calculateConductivity, calculatedVarCondResolution,
                 calculatedVarCondName, calculatedVarCondUnit,
                 calculatedVarCondCode, calculatedVarCondUUID),
    new Variable(calculatepH, calculatedVarpHResolution,
                 calculatedVarCondName, calculatedVarpHUnit,
                 calculatedVarpHCode, calculatedVarpHUUID),
...
const char *registrationToken = "a81b8d2d-8d7e-4287-8282-8e8b79104ebf";   // Device registration token
const char *samplingFeature = "b255d808-6239-4c65-ac79-0924d2ff5851";     // Sampling feature UUID
