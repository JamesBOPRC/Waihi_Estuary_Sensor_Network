...
const char *sketchName = "10_Matata.ino";
// Logger ID, also becomes the prefix for the name of the data file on SD card
const char *LoggerID = "Matata";
...
Variable *variableList[] = {
    ...
    new ProcessorStats_Battery(&mcuBoard,"dc4072f8-98c6-4b13-a017-c0b251c4f5c7"),
    new MaximDS3231_Temp(&ds3231,"046ee4cb-d5b8-496f-b198-37fe5a0aa2d9"),
    new DecagonCTD_Cond(&ctd, "b2435bc0-2737-43a7-827a-4e291365e8fd"),
    new DecagonCTD_Temp(&ctd, "e579e504-3625-4c30-9ea7-c833917a90b3"),
        new DecagonCTD_Depth(&ctd, "d7d45fb6-ee9d-48bb-9815-a6b626a435ad"),
        new YosemitechY511_Turbidity(&y511, "b1e0ea0f-c0a1-46af-bfca-b613bf7ae5d1"),
        new YosemitechY511_Temp(&y511, "b15ccd6b-1eef-411a-82fb-bd9f10c501f0")
...
const char *registrationToken = "99fad0e6-6419-403a-bbc0-24780149b30c";   // Device registration token
const char *samplingFeature = "3cd6a792-7616-48c2-883c-545869761d93";     // Sampling feature UUID
